...
using Com.Cognizant.MovieCruise.Dao;
using Com.Cognizant.MovieCruser.Model;

namespace MovieCruise
{
    class MovieList
    {
        public static void Main()
        {
            ...
            {
                {1,new Customer(1,"Chandrika") },
                {2,new Customer(2,"Sujith") },
                {3,new Customer(3,"Veda") },

            };
                //Favourites List
                List<Movie> favourites = new List<Movie> {
                new Movie(1, "Avatar", "$2,787,965,087", "Yes", "15/03/2017", "Science Fiction", "Yes"),
                new Movie(2, "The Avengers", "$1,158,234,345", "Yes", "21/12/2017", "SuperHero", "No") };
                ...
                else if (user == 2)
                {
                    ...
                    if (admin.AdminName == "Meena" && admin.AdminId == 1)
                    {
